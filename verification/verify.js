...
async function main() {
    ...
    try {
        ...
        await page.screenshot({ path: '/home/jules/verification/verification-overflow.png', fullPage: true });
        ...
        await page.evaluate(() => {
            window.checkAllSlidesLayout();
        });

        await page.waitForTimeout(500); // Wait for layout to settle
        await page.screenshot({ path: '/home/jules/verification/verification-underflow.png', fullPage: true });
