...
- `content-box is-ghost` / `surface-transparent`: variante sin fondo ni sombra que conserva padding/alineacion (��til para una columna limpia cuando la otra usa `surface-2`/`surface-3`).
